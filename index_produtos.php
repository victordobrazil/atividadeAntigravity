...
<div class="dashboard-container">
    <header>
        ...
        <nav style="align-items: center;">
            ...
            <a href="index_produtos.php" class="active">Produtos</a>
            <?php if($_SESSION['usuario_funcao'] === 'gerente'): ?>
            <a href="index_funcionario.php">Funcionários</a>
            <?php endif; ?>
    ...
    <div class="search-container">
        <form method="POST" action="index_produtos.php">
            <h4 style="margin-right: 1rem;">Pesquisar Produto:</h4>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $produto->id; ?></td>
                    <td>
                        <img src="<?= !empty($produto->imagem) ? 'uploads/' . $produto->imagem : 'uploads/sem-foto.png' ?>" style="width:40px; height:40px; border-radius:50%; object-fit:cover; border:2px solid var(--glass-border); background: #f8fafc; padding: 2px;">
                    </td>
                    <td><?= $produto->nome; ?></td>
                    <td class="action-links">
                        <a href="ver_produto.php?id=<?= $produto->id ?>" style="color:#f8fafc; font-weight:600;">Ver</a>
                        <a href="atualizar.php?alterar=<?= $produto->id ?>">Alterar</a>
                        <a href="index_produtos.php?excluir=<?= $produto->id ?>" class="delete">Excluir</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
