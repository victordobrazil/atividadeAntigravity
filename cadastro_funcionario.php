...
<div class="form-container">
    <h1 class="header-title">Novo Funcionário</h1>
    <p class="header-desc">Matricule um novo membro no sistema</p>

    <form action="cadastro_funcionario.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label>Nome Completo</label>
            <input type="text" name="funcionario[nome]" class="form-control" required autocomplete="off">
        </div>
        
        <div class="row-group">
            <div class="form-group">
                <label>CPF</label>
                <input type="text" name="funcionario[cpf]" class="form-control" required autocomplete="off">
            </div>
            <div class="form-group">
                <label>Telefone</label>
                <input type="text" name="funcionario[telefone]" class="form-control" required>
            </div>
        </div>

        <div class="form-group">
            <label>Endereço</label>
            <input type="text" name="funcionario[endereco]" class="form-control" required>
        </div>

        <div class="form-group">
            <label>Função</label>
            <input type="text" name="funcionario[funcao]" class="form-control" required placeholder="Ex: gerente">
        </div>

        <div class="row-group">
            <div class="form-group">
                <label>Login</label>
                <input type="text" name="funcionario[login]" class="form-control" required autocomplete="off">
            </div>
            <div class="form-group">
                <label>Senha</label>
                <input type="password" name="funcionario[senha]" class="form-control" required>
            </div>
        </div>
        ...
        <button type="submit" name="cadastrar" class="btn-submit">Criar Perfil</button>
    </form>
    
    <a href="index_funcionario.php" class="btn-back">← Voltar para Funcionários</a>
</div>
