...
<div class="form-container">
    <h1 class="header-title">Atualizar Produto</h1>
    <p class="header-desc">Edite as informações do produto #<?= $a->id ?></p>
    ...
    <form action="atualizar.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>Nome</label>
            <input type="text" name="produto[nome]" class="form-control" value="<?= trim($a->nome) ?>" required>
        </div>
        <div class="form-group">
            <label>Descrição</label>
            <input type="text" name="produto[descricao]" class="form-control" value="<?= trim($a->descricao) ?>" required>
        </div>
        <div class="form-group">
            <label>Quantidade</label>
            <input type="number" name="produto[quantidade]" class="form-control" value="<?= trim($a->quantidade) ?>" required>
        </div>
        <div class="form-group">
            <label>Preço</label>
            <input type="text" name="produto[preco]" class="form-control" value="<?= trim($a->preco) ?>" required>
        </div>
